...
export const routes: Routes = [
  ...
  // ===== WEBSITE ROUTES (Public) - with Layout =====
  {
    ...
    children: [
      ...
      // { path: 'product/:id', component: ProductDetailsComponent, data: { title: 'Product Details - Amigo Store' } },
      // { path: 'product/:_id', component: ProductDetailsComponent, data: { title: 'Product Details - Amigo Store' } },
